...
async function acceptChallenge( opponentPuzzleIds, gameState, opponentId,store){
    ...
    const newGameState = manageGameState({type: 'ACCEPTED', data: {challengerPuzzles, opponentPuzzles, challengerRating, opponentRating: opponent.rating, opponent: opponent.user_name}}, gameState)
